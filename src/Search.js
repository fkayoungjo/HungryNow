...
import { Button, Form, FormGroup, Label, Input,  Modal, ModalHeader, Jumbotron} from 'reactstrap';
      ...
      <div >
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} >
          <ModalHeader toggle={this.toggle}>Your Matches</ModalHeader>
            ...
            <ZomatoResults results={this.state.results} user={this.props.user} saveFavortie={this.props.saveFavortie}/>
            }
