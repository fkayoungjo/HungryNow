...
class DineIn extends Component {
  ...
  return (
      <div>
        ...
        <FormText>A keyword can be anything. From a dish such as lasagna, a meat such as chicken or salmon, a fruit, vegetable, or anything you have on hand. Enter one.</FormText>
        </FormGroup>
        </div>
        <div>
        <FormGroup>
